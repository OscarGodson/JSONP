 ...
 * @param {Function} callback  The callback you want to execute as an anonymous function. Use this if you do not want to use Promises.
 *
 * @example
...
(function(window, undefined) {
    var JSONP = function(url, data, method, callback) {
        return new Promise(function(resolve, reject) {
            ...
            var generatedFunction = 'jsonp' + Math.round(timestamp + Math.random() *
                1000001);
